...
$query = "select
    ...
    from carros
        ...
        inner join imagenescarros on imagenescarros.carro_id = carros.idCarro
...
<html>
    <head>
        ...
        <title>Administración de Status de usuario :: mercadomotor.com.ve</title>
