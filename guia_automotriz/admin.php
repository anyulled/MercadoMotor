...
local.idlocal,
local.nombre,
logoempresa as imagen,
GROUP_CONCAT(servicio ORDER BY servicio SEPARATOR', ') as servicios,
ciudad.ciudad,
estado.Estado,
usuarios.nombre as nombre_usuario
from local_has_servicio
inner join local on local_has_servicio.idlocal = local.idlocal
inner join servicio on local_has_servicio.idservicio = servicio.idservicio
inner join estado on local.estado_id =estado.idEstado
inner join ciudad on local.ciudad_id = ciudad.idciudad
inner join usuarios on local.usuario_id = usuarios.idusuarios
group by local.nombre ";
...
<html>
    <head>
        ...
        <title>Administración de locales:: mercadomotor.com.ve </title>
                            ...
                            <?php if (sizeof($local) > 0): ?>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th width="30%"> <a href="<?php echo $_SERVER['PHP_SELF']; ?>?order=4&dir=<?php echo(isset($_GET['dir']) && $_GET['dir'] == 'DESC') ? 'ASC' : "DESC"; ?>"> Servicios <img alt="Ordenar"  src="<?php echo ROOT . IMAGES . "toggle.gif" ?>" hspace="2" align="top"/></a></th>
                                        <th> <a href="<?php echo $_SERVER['PHP_SELF']; ?>?order=5&dir=<?php echo(isset($_GET['dir']) && $_GET['dir'] == 'DESC') ? 'ASC' : "DESC"; ?>"> Ciudad <img alt="Ordenar"  src="<?php echo ROOT . IMAGES . "toggle.gif" ?>" hspace="2" align="top"/></a></th>
                                ...
                                <tbody>
                                    <?php if ( $local['suceed'] && sizeof($local['data']) > 0): ?>
                                    <?php foreach ($local['data'] as $tempLocal): ?>
                                                <tr>
                                                    <td>
                                                        <a class="adminCarro" name="link<?php echo $tempLocal['idlocal']; ?>" href="#link<?php echo $tempLocal['idlocal']; ?>"> <?php echo $tempLocal['idlocal']; ?>
                                                            <img src="<?php echo ROOT . IMAGES  .LOCALES. $tempLocal['imagen']; ?>" alt="mercadomotor.com"/>
                                                        </a>
                                                    </td>
                                                    <td> <?php echo $tempLocal['nombre']; ?> </td>
                                                    <td> <?php echo $tempLocal['servicios']; ?> </td>
                                                    <td> <?php echo $tempLocal['ciudad']; ?> </td>
                                                    <td> <?php echo $tempLocal['Estado']; ?> </td>
                                                    <td> <?php echo $tempLocal['nombre_usuario']; ?> </td>
                                                    <td align="right">
                                                        <a href="editar.php?id=<?php echo $tempLocal['idlocal']; ?>"><img alt="Editar" align="absmiddle" src="../images/edit.png" /><span> Editar </span> </a>
