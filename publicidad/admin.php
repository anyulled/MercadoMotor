...
$query = "select publicaciones.*, usuarios.login as 'usuario' from publicaciones inner join usuarios on publicaciones.usuario_id = usuarios.idusuarios";
//// </editor-fold>
...
$publicaciones = $db->dame_query($query . $max);
?>
...
<html>
    <head>
        ...
        <title>Administración de Anuncios :: mercadomotor.com.ve</title>
                ...
                <div id="main">
                    ...
                    <div id="col2" class="mainCol">
                        <div id="col2_content" class="clearfix">
                            <?php if (sizeof($publicaciones) > 0): ?>
                                <table class="full">
                                    ...
                                    <tr>
                                        ...
                                        <th> <a href="<?php echo $_SERVER['PHP_SELF']; ?>?order=2&dir=<?php echo(isset($_GET['dir']) && $_GET['dir'] == 'DESC') ? 'ASC' : "DESC"; ?>">Titulo <img alt="Ordenar"  src="<?php echo ROOT . IMAGES . "toggle.gif" ?>" hspace="2" align="top"/></a></th>
                                        <th> <a href="<?php echo $_SERVER['PHP_SELF']; ?>?order=4&dir=<?php echo(isset($_GET['dir']) && $_GET['dir'] == 'DESC') ? 'ASC' : "DESC"; ?>">Url Destino <img alt="Ordenar"  src="<?php echo ROOT . IMAGES . "toggle.gif" ?>" hspace="2" align="top"/></a></th>
                                        <th> <a href="<?php echo $_SERVER['PHP_SELF']; ?>?order=5&dir=<?php echo(isset($_GET['dir']) && $_GET['dir'] == 'DESC') ? 'ASC' : "DESC"; ?>">Impresiones <img alt="Ordenar"  src="<?php echo ROOT . IMAGES . "toggle.gif" ?>" hspace="2" align="top"/></a></th>
                                        <th> <a href="<?php echo $_SERVER['PHP_SELF']; ?>?order=6&dir=<?php echo(isset($_GET['dir']) && $_GET['dir'] == 'DESC') ? 'ASC' : "DESC"; ?>">Clicks <img alt="Ordenar"  src="<?php echo ROOT . IMAGES . "toggle.gif" ?>" hspace="2" align="top"/></a></th>
                                        <th> <a href="<?php echo $_SERVER['PHP_SELF']; ?>?order=7&dir=<?php echo(isset($_GET['dir']) && $_GET['dir'] == 'DESC') ? 'ASC' : "DESC"; ?>">Usuario <img alt="Ordenar"  src="<?php echo ROOT . IMAGES . "toggle.gif" ?>" hspace="2" align="top"/></a></th>
                                        <th> Acción </th>
                                    </tr>
                                </thead>
                                    <tbody>
                                    <?php if (sizeof($publicaciones['data']) > 0): ?>
                                    <?php foreach ($publicaciones['data'] as $anuncio): ?>
                                                <tr>
                                                    <td>
                                                        <a class="adminCarro" name="link<?php echo $anuncio['idpublicaciones']; ?>" href="#link<?php echo $anuncio['idpublicaciones']; ?>"> <?php echo $anuncio['idpublicaciones']; ?>
                                                            <img src="<?php echo ROOT.IMAGES_ADS.$anuncio['urlImagen']; ?>" alt="imagen"/>
                                                        </a>
                                                    </td>
                                                    <td> <?php echo $anuncio['titulo']; ?> </td>
                                                    <td> <?php echo $anuncio['urlDestino']; ?> </td>
                                                    <td> <?php echo $anuncio['vecesVisto']; ?> </td>
                                                    <td> <?php echo $anuncio['vecesClick']; ?> </td>
                                                    <td> <?php echo $anuncio['usuario']; ?> </td>
                                                    <td align="right">
                                                        <a href="editar.php?id=<?php echo $anuncio['idpublicaciones']; ?>"><img alt="Editar" align="absmiddle" src="../images/edit.png" /><span> Editar </span> </a>
                            ...
                            <?php else: ?>
                            <p>no existen registros publicados</p>
                            <?php endif; ?>
                        </div>
                    </div>
