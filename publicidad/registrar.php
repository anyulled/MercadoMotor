...
if (isset($_POST['enviar'])) {
    $result = $ad->registrar($_POST,$_FILES);
    if (!$result) {
        trigger_error("No se pudo registrar la publicidad: " . var_export($result, 1), E_ERROR);
    }
    $errores = $error->error;
}
//// </editor-fold>
...
<html>
    <head>
        ...
        <title>Registrar Anuncio :: mercadomotor.com.ve </title>
                                        ...
                                        <div class="subcolumns">
                                            <div class="c50l">
                                                ...
                                                <div class="type-text">
                                                    ...
                                                    <input type="text" name="urlDestino" class="required"/>
                                                </div>
                                                <div class="type-text">
                                                    <label for="urlImagen">Url imagen <sup>*</sup> </label>
                                                    <input type="file" name="urlImagen" class="required"/> 
                                                </div>
                                            </div>
                                            <div class="c50r">
                                                <div class="type-select">
                                                    <label for="tipo-tipopublicacion">Tipo de anuncio <sup>*</sup> </label>
                                ...
                                <div class="floatbox">
                                    <div class="note">
                                        <p class="message">
                                            ...
                                            <span>Registro agregado con éxito.</span>
                                        </p>
                                    </div>
                                </div>
                            <?php endif; ?>
